        ...
        if(password=="aditya")
        {
            ...
            do{
                ...
                else if(command=="open oops book")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","C:\\Users\\HP\\Downloads\\ANJALI_SINGH_ (2).pdf",NULL, NULL, SW_NORMAL);
                }
                ...
                else if(command=="open video")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","E:\\Videos\\High Rated Gabru Nawabzaade 720p(JioBoss.In).mp4",NULL, NULL, SW_NORMAL);
                }
